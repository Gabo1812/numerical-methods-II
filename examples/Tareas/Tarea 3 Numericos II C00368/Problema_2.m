...
% Problema 2: Esfera entre placas paralelas, en 2D
clearvars;
V = 100; %V potencial de las placas
epsilon_r1 = 1;  % permitividad relativa espacio
epsilon_r2 = 80; % permitividad capa dielectrica
epsilon_0 = 8.85e-12;
epsilon2 = epsilon_0*epsilon_r1;
epsilon3 = epsilon_0*epsilon_r2;
%............... Creo los objetos ........................
...
x0 = 0;
y0 = 0;
r1 = 0.03; %m radio de la esfera
r2 = 0.05; %m radio externo de la capa dielectrica
...
gd = [R1,C1,C2];
ns = char('R1','C1','C2'); %funciona como etiqueta
ns = ns';
sf = '(R1+C2)-(C1)';
...
%Para la capa dielectrica
specifyCoefficients(model,'m',0,'d',0,'c',epsilon3,'a',0,'f',0,'Face',2);
...
applyBoundaryCondition(model,"dirichlet","Edge",5:8,'r',0,'h',1); %Esfera interna potencial 0 V
